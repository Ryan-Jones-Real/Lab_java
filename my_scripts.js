...
*/
        ...
        function switchPlayers(playerNum){
            ...
            var gamepl = players[playerNum].games_played;
            var psyds = players[playerNum].pass_yards;
            var rushyds = players[playerNum].rushing_yards;
            var recy = players[playerNum].receiving_yards;
            var avg_pyds = psyds / gamepl;
            var avg_ryds = rushyds / gamepl;
            var avg_recyds = recy / gamepl;
